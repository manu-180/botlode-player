...
import 'package:botlode_player/features/player/presentation/widgets/floating_bot_widget.dart'; // ⬅️ PASO 3.6: BURBUJA FLOTANTE
...
final appRouter = GoRouter(
  ...
  routes: [
    ...
    GoRoute(
      path: '/',
      builder: (context, state) => const FloatingBotWidget(), // ⬅️ PASO 3.6: BURBUJA → CLICK → SIMPLE CHAT
    ),
  ],
);