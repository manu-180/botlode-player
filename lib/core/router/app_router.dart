...
import 'package:botlode_player/features/player/presentation/views/simple_chat_test.dart';
...
final appRouter = GoRouter(
  ...
  routes: [
    ...
    GoRoute(
      path: '/',
      builder: (context, state) => const UltraSimpleBot(), // ⬅️ PASO 4.2: CHAT COMPLETO FUNCIONAL
    ),
  ],
);