...
import 'package:botlode_player/features/player/presentation/views/player_screen.dart'; // ⬅️ PASO 4.0: PANTALLA BASE CON OVERLAY
...
final appRouter = GoRouter(
  initialLocation: '/',
  routes: [
    // ÚNICA RUTA: PANTALLA BASE (contiene FloatingBotWidget → SimpleChatTest)
    GoRoute(
      path: '/',
      builder: (context, state) => const PlayerScreen(), // ⬅️ PASO 4.0: PANTALLA BASE PREVIENE TRANSPARENCIA
    ),
  ],
);