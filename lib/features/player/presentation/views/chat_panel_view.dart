...
/// ChatPanelView - Versión "Material Bootstrap"
/// 
/// Estrategia de solución:
/// Se introduce una capa explícita de `Material` con `MaterialType.transparency`
/// justo encima del fondo de vidrio. Esto obliga al motor de Flutter Web a 
/// reconocer el área como "dibujable" para los TextFields y Text widgets,
/// previniendo el error de renderizado fantasma (Pantalla Blanca).
  ...
  Widget build(BuildContext context) {
    ...
    final LinearGradient bgGradient = isDarkMode
        ? LinearGradient(
            ...
            colors: [const Color(0xFF1E1E2C).withOpacity(0.85), const Color(0xFF000000).withOpacity(0.90)])
          ...
          return Container(
            ...
            child: ClipRRect(
              ...
              child: Stack(
                ...
                children: [
                  // --- CAPA 0: FONDO ---
                  // Combinamos el Blur y el Gradiente en una sola capa sólida
                  Positioned.fill(
                    child: BackdropFilter(
                      filter: ImageFilter.blur(sigmaX: 15, sigmaY: 15), // Blur más fuerte para evitar transparencias raras
                      child: Container(
                        decoration: BoxDecoration(
                          gradient: bgGradient, 
                        ),
                  ...
                  // --- CAPA 1: CONTENIDO ---
                  // [SOLUCIÓN] Envolvemos todo en Material type transparency.
                  // Esto le da a los hijos un contexto de renderizado válido sobre el vidrio.
                  Material(
                    ...
                    child: Column(
                      children: [
                        ...
                        Expanded(
                          child: Container(
                            // Fondo transparente, el color lo da el Layer 0
