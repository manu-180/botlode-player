...
class _ChatPanelViewState extends ConsumerState<ChatPanelView> {
  ...
  Widget build(BuildContext context) {
    ...
    // --- ESTRUCTURA CORREGIDA PARA WEB (FIX BLANCO) ---
    return MouseRegion(
      ...
      // 1. LayoutBuilder: Asegura constraints firmes
      child: LayoutBuilder(
        builder: (context, constraints) {
          return Container(
            ...
            decoration: BoxDecoration(
              ...
              // NOTA: No ponemos color aquí para dejar que el filtro trabaje
            ),
            // 2. ClipRRect: MANDATORIO para contener el BackdropFilter en Web
            child: ClipRRect(
              borderRadius: BorderRadius.circular(28),
              child: Stack(
                fit: StackFit.expand, 
                children: [
                  // CAPA 0: FONDO DE VIDRIO (Aislada)
                  Positioned.fill(
                  ...
                  // CAPA 1: CONTENIDO DE LA INTERFAZ (Sobre el vidrio)
                  Column(
                    children: [
                      // HEADER
                      SizedBox(
                      ...
                      Expanded(
                        child: Container(
                          // Capa sutil para asegurar contraste
